                ...
                <div className="col-lg-4">
                    <div className="left">
                        ...
                        <div className="socials">
                            <a href="mailto:miladsafarishop@gmail.com" aria-label="انتقال به صفحه گیت هاب" className="footer-item"><i className="fa-brands fa-github"></i></a>
                            <a href="mailto:miladsafarishop@gmail.com" aria-label="انتقال به صفحه لینکدین" className="footer-item"><i className="fa-brands fa-linkedin-in"></i></a>
